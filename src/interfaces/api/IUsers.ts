import { ExpansionUser } from "src/types/x-api/get_me_query";
...
export interface IUsers {
   ...
   * ```
   */
  getMe(userFields?: UserField[], expansions?: ExpansionUser[], tweetFields?: TweetField[]): Promise<GetMeResponse>;
}
